...
#define STRING_CONFIG_H_AUTHOR "(Thomas Sauerwald, Custom Cantilever @SKR mini E3 V 1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Custom Cantilever"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 51.67
    #define DEFAULT_Ki 7.88
    #define DEFAULT_Kd 84.74
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 53.51
  #define DEFAULT_bedKi 10.45
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45 , 15 , -0.985 }
